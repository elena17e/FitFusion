...
class PassedClassesHomepageAdapter (private val trainingsList: ArrayList<TrainingModel>) : RecyclerView.Adapter<PassedClassesHomepageAdapter.TrainingViewHolder>() {
